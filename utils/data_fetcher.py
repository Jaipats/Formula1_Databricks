...
class F1DataFetcher:
    ...
    def fetch_all_data(self) -> Dict[str, pd.DataFrame]:
        ...
        if endpoints.get('session_result'):
            all_data['session_result'] = self._fetch_session_results(session_keys)
        ...
        if endpoints.get('car_data') or endpoints.get('position') or endpoints.get('location'):
            all_data.update(self._fetch_driver_specific_data(session_keys, endpoints))
    ...
    def _fetch_laps(self, session_keys: List[int]) -> pd.DataFrame:
        ...
        for session_key in session_keys:
            try:
                ...
                logger.error(f"Error fetching laps for session {session_key}: {str(e)}")
    ...
    def _fetch_pit_stops(self, session_keys: List[int]) -> pd.DataFrame:
        ...
        for session_key in session_keys:
            try:
                ...
                logger.error(f"Error fetching pit stops for session {session_key}: {str(e)}")
    ...
    def _fetch_stints(self, session_keys: List[int]) -> pd.DataFrame:
        ...
        for session_key in session_keys:
            try:
                ...
                logger.error(f"Error fetching stints for session {session_key}: {str(e)}")
    ...
    def _fetch_weather(self, session_keys: List[int]) -> pd.DataFrame:
        ...
        for session_key in session_keys:
            try:
                ...
                logger.error(f"Error fetching weather for session {session_key}: {str(e)}")
    ...
    def _fetch_race_control(self, session_keys: List[int]) -> pd.DataFrame:
        ...
        logger.info(f"Fetching race control for {len(session_keys)} sessions...")
        all_rc = []
        ...
        for session_key in session_keys:
            try:
                ...
                logger.error(f"Error fetching race control for session {session_key}: {str(e)}")
    ...
    def _fetch_team_radio(self, session_keys: List[int]) -> pd.DataFrame:
        ...
        for session_key in session_keys:
            try:
                ...
                logger.error(f"Error fetching team radio for session {session_key}: {str(e)}")
    ...
    def _fetch_intervals(self, session_keys: List[int]) -> pd.DataFrame:
        ...
        for session_key in session_keys:
            try:
                ...
                logger.error(f"Error fetching intervals for session {session_key}: {str(e)}")
    ...
    def _fetch_overtakes(self, session_keys: List[int]) -> pd.DataFrame:
        ...
        for session_key in session_keys:
            try:
                ...
                logger.error(f"Error fetching overtakes for session {session_key}: {str(e)}")
    ...
    def _fetch_session_results(self, session_keys: List[int]) -> pd.DataFrame:
        ...
        logger.info(f"Fetching session results for {len(session_keys)} sessions...")
        all_results = []
        ...
        for session_key in session_keys:
            try:
                ...
                logger.error(f"Error fetching session results for session {session_key}: {str(e)}")
    ...
    def _fetch_starting_grid(self, session_keys: List[int]) -> pd.DataFrame:
        ...
        logger.info(f"Fetching starting grid for {len(session_keys)} sessions...")
        all_grids = []
        ...
        for session_key in session_keys:
            try:
                ...
                logger.error(f"Error fetching starting grid for session {session_key}: {str(e)}")
