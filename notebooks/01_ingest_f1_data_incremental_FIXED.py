...
# MAGIC %md
# MAGIC # Formula 1 Data Ingestion - Incremental (Memory-Efficient)
# MAGIC
# MAGIC This notebook fetches data from the OpenF1 API and writes it directly to volume WITHOUT loading everything into memory.
# MAGIC
# MAGIC **Benefits:**
# MAGIC - Memory efficient - writes each batch immediately
# MAGIC - Won't crash - doesn't load all data at once
# MAGIC - Resilient - can resume from where it left off
