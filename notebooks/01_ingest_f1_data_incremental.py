...
print(f"✓ Ensured volume exists: {config.catalog}.{config.schema}.pipeline_storage")
...
print(f"✓ Staging path: /Volumes/{config.catalog}/{config.schema}/pipeline_storage/staging")
...
print(f"✓ Volume location: /Volumes/{config.catalog}/{config.schema}/pipeline_storage/staging/")
